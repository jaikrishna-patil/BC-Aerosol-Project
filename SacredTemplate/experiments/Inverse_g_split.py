...
if __name__ == '__main__':
    ...
    def main(params, _run):
        ...
        if params.split_type == 'interpolating':
            ...
            train_set = df[(df['g'] < params.split_lower) | (df['g'] > params.split_upper)]
            test_set = df[(df['g'] >= params.split_lower) & (df['g'] <= params.split_upper)]

        elif params.split_type == 'extrapolating_lower':
            train_set = df[(df['g'] > params.split_lower)]
            test_set = df[(df['g'] <= params.split_lower)]
        elif params.split_type == 'extrapolating_upper':
            train_set = df[(df['g'] < params.split_upper)]
            test_set = df[(df['g'] >= params.split_upper)]
