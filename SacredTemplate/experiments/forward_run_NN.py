...
if __name__ == '__main__':
    ...
    def main(params, _run):
        ...
        model.add(Dense(3, kernel_initializer=params.kernel_initializer, activation='linear'))
        ...
        filepath = f"forward_run_{_run._id}/best_model.hdf5"
        with make_experiment_tempfile('best_model.hdf5', _run, mode='wb', suffix='.hdf5') as model_file:
            ...
            weights_file = f'forward_run_{_run._id}/best_model.hdf5'  # choose the best checkpoint
        ...
        Y_test = pd.DataFrame(data=Y, columns=["q_abs", "q_sca", "g"])
