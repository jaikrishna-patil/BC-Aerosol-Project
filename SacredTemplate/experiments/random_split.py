...
if __name__ == '__main__':
    ...
    def main(params, _run):
        ...
        X_train, X_test, Y_train, Y_test = train_test_split(
            ...
            test_size=0.25,
            random_state=10)
        #int(np.random.randint(2,100, size=1))
        ...
        with make_experiment_tempfile('best_model.hdf5', _run, mode='wb', suffix='.hdf5') as model_file:
            ...
            history = model.fit(X_train_transformed, Y_train, epochs=params.epochs, batch_size=params.batch_size, validation_split=0.2, callbacks=callback_list)
